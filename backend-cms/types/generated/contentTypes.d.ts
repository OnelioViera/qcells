...
export interface ApiBeamTypeBeamType extends Struct.CollectionTypeSchema {
  collectionName: 'beam_types';
  info: {
    displayName: 'Beam Type';
    pluralName: 'beam-types';
    singularName: 'beam-type';
  };
  options: {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String &
      ...
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    technicalDrawing: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    type: Schema.Attribute.Enumeration<['center', 'end']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    copyrightText: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'(c) 2025 Lindsay Precast | QCELLS Cowboy II Bess Grade Beam Project'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footerDescription: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Specializing in industrial precast structures'>;
    lindsayLogo: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    heroSubtitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Grade Beams'>;
...
export interface ApiManufacturingStepManufacturingStep
  extends Struct.CollectionTypeSchema {
  collectionName: 'manufacturing_steps';
  info: {
    displayName: 'Manufacturing Step';
    pluralName: 'manufacturing-steps';
    singularName: 'manufacturing-step';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    centerBeams: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    manufacturing_steps: Schema.Attribute.Relation<
      'oneToMany',
      'api::manufacturing-step.manufacturing-step'
    >;
...
export interface ApiRebarConfigRebarConfig extends Struct.CollectionTypeSchema {
  collectionName: 'rebar_configs';
  info: {
    displayName: 'Rebar Config';
    pluralName: 'rebar-configs';
    singularName: 'rebar-config';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    barSize: Schema.Attribute.String;
    cover: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    drawings: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::rebar-config.rebar-config': ApiRebarConfigRebarConfig;
